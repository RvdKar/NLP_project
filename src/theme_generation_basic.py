...
themes = {'finance':  re.compile(r"\b(rent|loan|debt|money|bills?|salary|wages?|paycheck|finance|expensive|cheap|broke|sales?|discount)\b", re.IGNORECASE),
          'relationships': re.compile(r"\b(girlfriend|boyfriend|husband|wife|partner|spouse|fiance|relationship|dating|ex|cheat(ed)?|valentine|bf|gf)\b", re.IGNORECASE),
...
''' This is the result:
Counter({'societal norms': 61539, 'family': 52716, 'relationships': 47965, 'finance': 37687, 'friendship': 37528, 'work': 34511, 'education': 31495})
'''